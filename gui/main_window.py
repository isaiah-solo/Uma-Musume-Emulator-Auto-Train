...
class MainWindow:
    ...
    def create_widgets(self):
        ...
        main_frame.grid_columnconfigure(0, weight=3)  # Left column - give more space to config + status
        main_frame.grid_columnconfigure(1, weight=1)  # Right column - reduce log panel size
